...
import (
	...
	errors2 "github.com/abdivasiyev/go-admin/modules/errors"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/abdivasiyev/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/abdivasiyev/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
